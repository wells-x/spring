...
public class DateKit {
    public static Date localToDate(LocalDateTime endTime) {
        ZonedDateTime zdt = endTime.atZone(ZoneOffset.systemDefault());
    ...
    /**
     * 获取YYYY-MM-DD HH:mm:kaptha.SSS格式
     *
     * @return
     */
    ...
    public static String format(Timestamp timestamp) {
        return sdfDay.format(new Date(timestamp.getTime()));
    }
    ...
    public static String getAfterDayDate(String days) {
        ...
        SimpleDateFormat sdfd = new SimpleDateFormat("yyyy-MM-dd HH:mm:kaptha");
